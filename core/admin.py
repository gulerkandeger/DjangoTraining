...
class EducationAdmin(admin.ModelAdmin):
    list_display = ['id','school_name','major','start_date','end_date','updated_date','created_date']
    search_fields = ['school_name','major']
    list_editable = ['school_name','major','start_date','end_date']
    class Meta:
        model = Education
...
class DocumentAdmin(admin.ModelAdmin):
    list_display = ['id','slug','button_text','file','order','updated_date','created_date']
    search_fields = ['slug','button_text']
    list_editable = ['slug','button_text','file','order']
    class Meta:
        model = Document
